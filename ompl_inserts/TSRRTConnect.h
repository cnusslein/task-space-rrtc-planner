#ifndef OMPL_GEOMETRIC_PLANNERS_RRT_TSRRT_CONNECT_
#define OMPL_GEOMETRIC_PLANNERS_RRT_TSRRT_CONNECT_
...
namespace ompl
{
    namespace geometric
    {
        /**
           ...
           The basic idea is to grow two TSRRTs, one from the start and
        ...
        */
        ...
        /** \brief TSRRT-Connect (TSRRTConnect) */
        class TSRRTConnect : public base::Planner
        {
        public:
            /** \brief Constructor */
            TSRRTConnect(const base::SpaceInformationPtr &si, bool addIntermediateStates = false);

            ~TSRRTConnect() override;
