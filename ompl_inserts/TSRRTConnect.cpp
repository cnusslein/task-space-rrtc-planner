#include "ompl/geometric/planners/rrt/TSRRTConnect.h"
#include "ompl/base/goals/GoalSampleableRegion.h"
#include "ompl/tools/config/SelfConfig.h"
#include "ompl/util/String.h"

ompl::geometric::TSRRTConnect::TSRRTConnect(const base::SpaceInformationPtr &si, bool addIntermediateStates)
  : base::Planner(si, addIntermediateStates ? "TSRRTConnectIntermediate" : "TSRRTConnect")
{
    specs_.recognizedGoal = base::GOAL_SAMPLEABLE_REGION;
    specs_.directed = true;

    Planner::declareParam<double>("range", this, &TSRRTConnect::setRange, &TSRRTConnect::getRange, "0.:1.:10000.");
    Planner::declareParam<bool>("intermediate_states", this, &TSRRTConnect::setIntermediateStates,
                                &TSRRTConnect::getIntermediateStates, "0,1");
...
ompl::geometric::TSRRTConnect::~TSRRTConnect()
{
    freeMemory();
}

void ompl::geometric::TSRRTConnect::setup()
{
    Planner::setup();
...
void ompl::geometric::TSRRTConnect::freeMemory()
{
...
void ompl::geometric::TSRRTConnect::clear()
{
    Planner::clear();
    sampler_.reset();
    freeMemory();
...
ompl::geometric::TSRRTConnect::GrowState ompl::geometric::TSRRTConnect::growTree(TreeData &tree, TreeGrowingInfo &tgi,
                                                                             Motion *rmotion)
{
...
ompl::base::PlannerStatus ompl::geometric::TSRRTConnect::solve(const base::PlannerTerminationCondition &ptc)
{
    checkValidity();
...
void ompl::geometric::TSRRTConnect::getPlannerData(base::PlannerData &data) const
{
